...
echo Starting initial preprocessing...
#run script that selects random samples from PolyA to create MergedData_reduced.tsv, and MergedLabels_reduced.ts
python ./scripts/init_data_pp.py
